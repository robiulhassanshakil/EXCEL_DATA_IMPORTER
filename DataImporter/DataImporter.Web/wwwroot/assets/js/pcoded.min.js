...
function menulayout() {
    ...
    }), e < 992 ? $(".pcoded-navbar").hasClass("theme-horizontal") && ($(".pcoded-navbar").addClass("theme-horizontal-dis"), $(".pcoded-navbar").removeClass("theme-horizontal")) : $(".pcoded-navbar").hasClass("theme-horizontal-dis") && ($(".pcoded-navbar").addClass("theme-horizontal"), $(".pcoded-navbar").removeClass("theme-horizontal-dis"))
}
...
$(document).ready(function () {
    ...
    if ($(".to-do-list input[type=checkbox]").on("click", function () {
        ...
        $(this);
        $(".main-search").addClass("open"), o <= 991 ? $(".main-search .form-control").css({
            width: "90px"
    ...
    $(".card-option .close-card").on("click", function () {
        ...
        } else $("body").css("overflow", ""), o.removeAttr("style"), setTimeout(function () {
            $("html,body").animate({
        ...
        var e = $(this);
        e.children(".spinner-border").show(), e.children(".spinner-grow").show(), e.children(".load-text").show(), e.children(".btn-text").hide(), e.attr("disabled", "true"), setTimeout(function () {
...
}), $(window).scroll(function () { }), $.fn.pcodedmenu = function (e) {
    var o = (this.attr("id"), {
            ...
            HandleSubMenuTrigger: function () {
                ...
                if (1 == $(".pcoded-navbar").hasClass("theme-horizontal") || 1 == $(".pcoded-navbar").hasClass("theme-horizontal-dis"))
                    if (d >= 992) {
                        ...
                        n.off("click").off("mouseenter mouseleave").hover(function () {
                        ...
                        n.off("mouseenter mouseleave").off("click").on("click", function (e) {
                            e.stopPropagation();
                            var o = $(this).closest(".pcoded-submenu").length;
                            console.log("123123"), 0 === o ? $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideUp()) : ($("pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar > .pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger").children(".pcoded-submenu").slideUp(), $(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"), $(this).addClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideDown()) : $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideUp()) : ($("pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar > .pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger").children(".pcoded-submenu").slideUp(), $(this).closest(".pcoded-submenu").find("li.pcoded-trigger").removeClass("pcoded-trigger"), $(this).addClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideDown())
                        })
                    } switch (e.SubMenuTrigger) {
                        case "click":
                            $(".pcoded-navbar .pcoded-hasmenu").removeClass("is-hover"), $(".pcoded-inner-navbar > .pcoded-hasmenu > .pcoded-submenu > li > .pcoded-submenu > li").on("click", function (e) {
            ...
            HandleMenuTrigger: function () {
                if ($(window).width() >= 992) {
                    if (1 == $(".pcoded-navbar").hasClass("theme-horizontal")) {
                        ...
                        o.off("click").off("mouseenter mouseleave").hover(function () {
                            if ($(this).addClass("pcoded-trigger").addClass("active"), $(".pcoded-submenu", this).length) {
                                ...
                                if ($(window).height(), d + n <= $(window).width()) $(this).removeClass("edge");
                                    ...
                                    $(".sidenav-inner").css({
                                        "margin-left": parseInt(s.slice(12, s.length - 3)) - 80
                    ...
                    o.off("mouseenter mouseleave").off("click").on("click", function () {
    ...
    $("body").hasClass("layout-14") || this.href == e && "" != $(this).attr("href") && ($(this).parent("li").addClass("active"), $(".pcoded-navbar").hasClass("theme-horizontal") || ($(this).parent("li").parent().parent(".pcoded-hasmenu").addClass("active").addClass("pcoded-trigger"), $(this).parent("li").parent().parent(".pcoded-hasmenu").parent().parent(".pcoded-hasmenu").addClass("active").addClass("pcoded-trigger")), $(this).parent("li").parent().parent(".sidelink").addClass("active"), $(this).parent("li").parent().parent().parent().parent(".sidelink").addClass("active"), $(this).parent("li").parent().parent().parent().parent().parent().parent(".sidelink").addClass("active"))
}), $(window).scroll(function () {
    $(".pcoded-header").hasClass("headerpos-fixed") || ($(this).scrollTop() > 60 ? ($(".pcoded-navbar.menupos-fixed").css("position", "fixed"), $(".pcoded-navbar.menupos-fixed").css("transition", "none"), $(".pcoded-navbar.menupos-fixed").css("margin-top", "0px")) : ($(".pcoded-navbar.menupos-fixed").removeAttr("style"), $(".pcoded-navbar.menupos-fixed").css("position", "absolute"), $(".pcoded-navbar.menupos-fixed").css("margin-top", "60px"))), $("body").hasClass("box-layout") && ($(this).scrollTop() > 60 ? ($(".pcoded-navbar").css("position", "fixed"), $(".pcoded-navbar").css("transition", "none"), $(".pcoded-navbar").css("margin-top", "0px"), $(".pcoded-navbar").css("border-radius", "0px")) : ($(".pcoded-navbar").removeAttr("style"), $(".pcoded-navbar").css("position", "absolute"), $(".pcoded-navbar").css("margin-top", "60px")))
